    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="insert.php">Add Student</a>
            </div>
        </div>
    </nav>
        ...
        <form method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" name="age" min="16" max="100" value="<?php echo $age; ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="course" required>
                        ...
                        <option value="Mathematics" <?php echo ($course === 'Mathematics') ? 'selected' : ''; ?>>Mathematics</option>
                    </select>
                </div>
            </div>
            <button type="submit" class="btn btn-primary">Add Student</button>
            <a href="select.php" class="btn btn-secondary">View All Students</a>
        </form>
    </div>
